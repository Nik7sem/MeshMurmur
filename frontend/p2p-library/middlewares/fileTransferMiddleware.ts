...
import {processedFileType, eventDataType, fileProgressType} from "@p2p-library/types.ts";
import {getShort} from "@p2p-library/helpers.ts";
import {FILE_CHUCK_WHOLE_SIZE, FILE_CHUNK_DATA_SIZE} from "@p2p-library/connection/DataChannel.ts";
